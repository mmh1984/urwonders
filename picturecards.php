...
<body>
    ...
    <div class="container">
        <div class="intro">
            <h2 class="text-center">Picture Cards</h2>
            <p class='text-center'>No of cards <span id="count" class='text-primary'>0</span></p>
            <p class="text-center"><input type='text' id="keyword" class='form-control' placeholder='type anything to search'/></p>
        </div>
        <div class="row photos" id="cards">
